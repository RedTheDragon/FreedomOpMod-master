...
public enum TFM_PlayerRank
{
    ...
    FOP_DEVELOPER("a " + ChatColor.DARK_PURPLE + "FreedomOpMod Developer", ChatColor.DARK_PURPLE + "[FOPM Dev]"),
    LEAD_DEV("the " + ChatColor.DARK_PURPLE + "Lead Developer", ChatColor.DARK_PURPLE + "[Lead Dev]"),
    IFM_DEV("a " + ChatColor.DARK_PURPLE + "Developer", ChatColor.DARK_PURPLE + "[Dev]"),
    RED("the " + ChatColor.BLUE + "IslandFreedomMod Creator", ChatColor.BLUE+ "[IFM Creator]"),
    ...
    CO("the " + ChatColor.BLUE + "Co Owner", ChatColor.BLUE + "[Co Owner]"),
    ...
    public static TFM_PlayerRank fromSender(CommandSender sender)
    {
        ...
        else if (sender.getName().equals("Alex33856"))
        {
            return LEAD_DEV;
        }
        
        else if (sender.getName().equals("RedTheDragon_"))
        {
            return RED;
        }
        
        else if (sender.getName().equals("LegendIsAwesomes"))
        {
            return CO;
        }
